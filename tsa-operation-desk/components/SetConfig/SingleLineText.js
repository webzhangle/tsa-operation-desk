...
let $ = layui.jquery
export default class SingleLineText {
    render (item) {
        return `<div class="component component-${item.uuid}" style="margin-bottom: 24PX;" id="id-SingleLineText-${item.uuid}">
    ...
    static name = 'SingleLineText'
    static delete (item, fillComponentsList) {
        $(`#id-SingleLineText-${item.uuid} .delete`).each(function () {
